...
const LOCATIONS_COORDS = {
  ...
  QGA2: { lat: 30.070158, lng: 31.518266 },
  QGA3: { lat: 30.217583, lng: 31.46425 },
  QGA4: { lat: 29.966799, lng: 30.932041 },

  QCC1: { lat: 30.068705, lng: 31.387586 },
  QCC2: { lat: 30.0132757392, lng: 31.5177883952 },
  QCC4: { lat: 30.009556, lng: 31.295412 },
  QCC6: { lat: 30.111052, lng: 31.26234 },
  QCC7: { lat: 30.0062315, lng: 31.1968446 },
  QCC8: { lat: 30.290134, lng: 31.763468 },

  QCD1: { lat: 31.2383, lng: 29.96255 },
  QCD2: { lat: 31.207231, lng: 29.932804 },
  QCD3: { lat: 29.9995547, lng: 30.9804908 },
  ...
  QCE1: { lat: 31.16856459970014, lng: 27.611934854975818 },
  QCE2: { lat: 31.068040029971577, lng: 28.059944148737436 },
  QCD8: { lat: 30.82964099282016, lng: 28.982527516358257 },
...
const haversineDistance = (coords1, coords2) => {
  ...
  const R = 6371e3;
  const dLat = toRad(coords2.lat - lat1_num);
  const dLon = toRad(coords2.lng - lng1_num);
  const lat1 = toRad(lat1_num);
